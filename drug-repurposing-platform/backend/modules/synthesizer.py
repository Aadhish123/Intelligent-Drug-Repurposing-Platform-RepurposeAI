...
--- CROSS-DOMAIN CONTEXT (from context memory layer) ---
{cross_domain_context}

Based on ALL the above data, generate a structured drug repurposing opportunity report.
...
{{
  ...
  "cross_domain_insight": "One insight ONLY visible when combining clinical + patent + market + regulatory data together"
}}"""
